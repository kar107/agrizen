    ...
    <div>
      ...
      <section className="relative h-[600px]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            ...
            >
              Smart Farming for a <br />Better Tomorrow
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Transform your agricultural practices with our comprehensive management system. 
              Connect with suppliers, track your crops, and grow your business.
            </motion.p>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our platform provides comprehensive solutions for modern farming needs, 
              helping you maximize efficiency and productivity.
            </p>
          </div>
      ...
      <section className="bg-green-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">Join thousands of farmers who are already growing with AgroSmart</p>
