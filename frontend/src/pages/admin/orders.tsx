...
const AdminOrders: React.FC = () => {
  ...
  const API_URL = "http://localhost/agrizen/backend/adminController/adminordersController.php";
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 ml-[280px] p-4 sm:p-6 overflow-x-auto">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4">Orders Management</h1>
              ...
              <tbody>
                {currentOrders.map((order) => (
                  <tr key={order.order_id} className="border">
                    ...
                    <td className="border p-2 whitespace-pre-wrap">{order.shipping_address}</td>
                    <td className="border p-2">
